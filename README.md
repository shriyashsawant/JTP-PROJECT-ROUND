...
*   **Decoupled Semantic Retrieval**: The core application runs embedding generation locally using `BAAI/bge-small-en-v1.5`. This design handles matching without mandatory external LLM API dependencies, allowing the application to run fully offline.
